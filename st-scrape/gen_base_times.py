...
BLOCKS = [
    ...
    {
        # WA SCM edition valid 2020-09-01..2021-08-31 -> Danish season 2021.
        # Source: FINA-Points-Base-times-SCM-and-LCM-2020.md (SCM half).
        'wa_label': 'SCM 2020', 'course': 'SCM', 'season': 2021,
        'validity_start': '2020-09-01', 'validity_end': '2021-08-31',
        'individual': [
            (50, 'Free', '20.24', 20.24, '22.93', 22.93),
            (100, 'Free', '44.94', 44.94, '50.25', 50.25),
            (200, 'Free', '1:39.37', 99.37, '1:50.43', 110.43),
            (400, 'Free', '3:32.25', 212.25, '3:53.92', 233.92),
            (800, 'Free', '7:23.42', 443.42, '7:59.34', 479.34),
            (1500, 'Free', '14:08.06', 848.06, '15:18.01', 918.01),
            (50, 'Back', '22.22', 22.22, '25.67', 25.67),
            (100, 'Back', '48.88', 48.88, '54.89', 54.89),
            (200, 'Back', '1:45.63', 105.63, '1:59.23', 119.23),
            (50, 'Breast', '25.25', 25.25, '28.56', 28.56),
            (100, 'Breast', '55.61', 55.61, '1:02.36', 62.36),
            (200, 'Breast', '2:00.16', 120.16, '2:14.57', 134.57),
            (50, 'Fly', '21.75', 21.75, '24.38', 24.38),
            (100, 'Fly', '48.08', 48.08, '54.61', 54.61),
            (200, 'Fly', '1:48.24', 108.24, '1:59.61', 119.61),
            (100, 'Medley', '50.26', 50.26, '56.51', 56.51),
            (200, 'Medley', '1:49.63', 109.63, '2:01.86', 121.86),
            (400, 'Medley', '3:54.81', 234.81, '4:18.94', 258.94),
        ],
        'relay': [
            (4, 50, 'Free', '1:21.80', 81.80, '1:33.91', 93.91),
            (4, 100, 'Free', '3:03.03', 183.03, '3:26.53', 206.53),
            (4, 200, 'Free', '6:46.81', 406.81, '7:32.85', 452.85),
            (4, 50, 'Medley', '1:30.44', 90.44, '1:42.38', 102.38),
            (4, 100, 'Medley', '3:19.16', 199.16, '3:45.20', 225.20),
        ],
        'mixed': [],
    },
    {
        # WA LCM edition valid 2021-01-01..2021-12-31 -> Danish season 2021.
        # Source: FINA-Points-Base-times-SCM-and-LCM-2020.md (LCM half).
        'wa_label': 'LCM 2021', 'course': 'LCM', 'season': 2021,
        'validity_start': '2021-01-01', 'validity_end': '2021-12-31',
        'individual': [
            (50, 'Free', '20.91', 20.91, '23.67', 23.67),
            (100, 'Free', '46.91', 46.91, '51.71', 51.71),
            (200, 'Free', '1:42.00', 102.00, '1:52.98', 112.98),
            ...
            (800, 'Free', '7:32.12', 452.12, '8:04.79', 484.79),
            (1500, 'Free', '14:31.02', 871.02, '15:20.48', 920.48),
            (50, 'Back', '24.00', 24.00, '26.98', 26.98),
            (100, 'Back', '51.85', 51.85, '57.57', 57.57),
            (200, 'Back', '1:51.92', 111.92, '2:03.35', 123.35),
            (50, 'Breast', '25.95', 25.95, '29.40', 29.40),
            (100, 'Breast', '56.88', 56.88, '1:04.13', 64.13),
            (200, 'Breast', '2:06.12', 126.12, '2:19.11', 139.11),
            (50, 'Fly', '22.27', 22.27, '24.43', 24.43),
            (100, 'Fly', '49.50', 49.50, '55.48', 55.48),
            (200, 'Fly', '1:50.73', 110.73, '2:01.81', 121.81),
            (200, 'Medley', '1:54.00', 114.00, '2:06.12', 126.12),
            (400, 'Medley', '4:03.84', 243.84, '4:26.36', 266.36),
        ],
        'relay': [
            (4, 100, 'Free', '3:08.24', 188.24, '3:30.05', 210.05),
            (4, 200, 'Free', '6:58.55', 418.55, '7:41.50', 461.50),
            (4, 100, 'Medley', '3:27.28', 207.28, '3:50.40', 230.40),
        ],
        'mixed': [],
    },
    {
        # WA SCM edition valid 2021-09-01..2022-08-31 -> Danish season 2022.
        # Source: FINA-Points-Base-times-SCM-and-LCM-2021.md (SCM half). No mixed
        # relays in this older FINA edition.
        'wa_label': 'SCM 2021', 'course': 'SCM', 'season': 2022,
        'validity_start': '2021-09-01', 'validity_end': '2022-08-31',
        'individual': [
            ...
            (800, 'Free', '7:23.42', 443.42, '7:59.34', 479.34),
            (1500, 'Free', '14:08.06', 848.06, '15:18.01', 918.01),
            (50, 'Back', '22.22', 22.22, '25.60', 25.60),
            (100, 'Back', '48.33', 48.33, '54.89', 54.89),
            (200, 'Back', '1:45.63', 105.63, '1:58.94', 118.94),
            (50, 'Breast', '25.25', 25.25, '28.56', 28.56),
            (100, 'Breast', '55.34', 55.34, '1:02.36', 62.36),
            (200, 'Breast', '2:00.16', 120.16, '2:14.57', 134.57),
            (50, 'Fly', '21.75', 21.75, '24.38', 24.38),
            (100, 'Fly', '47.78', 47.78, '54.61', 54.61),
            (200, 'Fly', '1:48.24', 108.24, '1:59.61', 119.61),
    ...
    {
        # WA SCM edition valid 2024-09-01..2025-08-31 -> Danish season 2025.
        # Source: World-Aquatics-Points-Base-times-SCM-and-LCM-2024.md (SCM half).
        'wa_label': 'SCM 2024', 'course': 'SCM', 'season': 2025,
        'validity_start': '2024-09-01', 'validity_end': '2025-08-31',
        'individual': [
            (50, 'Free', '20.16', 20.16, '22.93', 22.93),
            (100, 'Free', '44.84', 44.84, '50.25', 50.25),
            (200, 'Free', '1:39.37', 99.37, '1:50.31', 110.31),
